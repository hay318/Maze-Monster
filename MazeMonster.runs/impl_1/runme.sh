...
HD_PWD='C:/Users/Han-B/Lab_FinalA/Lab_FinalA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log music.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source music.tcl -notrace

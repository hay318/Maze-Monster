...
HD_PWD='C:/Users/Han-B/Lab_FinalA/Lab_FinalA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log music.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source music.tcl
